...
from SwinDER.network.DCNv2 import DeformableConvV2
...
class SABlock(nn.Module):
    ...
    def __init__(
        ...
        self.attenblock = ConvAttentionBlock(spatial_dims=spatial_dims, in_channels=in_channels, out_channels=out_channels,\
                                             stride=1, kernel_size=3, norm_name=norm_name, act_name=act_name, dropout=None)
...
class ResBlock(nn.Module):
    """
    A skip-connection based module with Deformable Convolution that can be used for DynUNet, based on:
    `Automated Design of Deep Learning Methods for Biomedical Image Segmentation <https://arxiv.org/abs/1904.08128>`_.
    `nnU-Net: Self-adapting Framework for U-Net-Based Medical Image Segmentation <https://arxiv.org/abs/1809.10486>`_.
    `Deformable ConvNets v2: More Deformable, Better Results <https://arxiv.org/abs/1811.11168>`_.
...
class BasicBlock(nn.Module):
    """
    A CNN module with Deformable Convolution that can be used for DynUNet, based on:
    `Automated Design of Deep Learning Methods for Biomedical Image Segmentation <https://arxiv.org/abs/1904.08128>`_.
    `nnU-Net: Self-adapting Framework for U-Net-Based Medical Image Segmentation <https://arxiv.org/abs/1809.10486>`_.
    `Deformable ConvNets v2: More Deformable, Better Results <https://arxiv.org/abs/1811.11168>`_.
...
class ConvAttentionBlock(nn.Module):
    """
    The additional attention path of the Squeeze-and-attention(SA) module, based on:
    `Squeeze-and-Attention Networks for Semantic Segmentation <https://arxiv.org/abs/1909.03402>`_.
