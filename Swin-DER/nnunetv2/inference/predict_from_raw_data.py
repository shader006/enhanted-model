...
def predict_entry_point():
    ...
    parser.add_argument('--onsampling', action='store_true', required=False,
                        help='[OPTIONAL] Force the decoder upsampling method to onsampling.')
