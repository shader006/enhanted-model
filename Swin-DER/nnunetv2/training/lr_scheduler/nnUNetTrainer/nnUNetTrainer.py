...
from SRUNet.wavelet_downsampling import WaveletDownsampleD, WaveletDownsampleArray
...
from nnunetv2.training.lr_scheduler.lr_scheduler import PolyLRScheduler
...
class nnUNetTrainer(object):
    ...
    def initialize(self):
        if not self.was_initialized:
            ...
            # waveletdownsample_array = WaveletDownsampleArray(ds_scales=self.wavelet_scales)
    ...
    def get_training_transforms(patch_size: Union[np.ndarray, Tuple[int]],
        ...
        if deep_supervision_scales is not None:
            tr_transforms.append(DownsampleSegForDSTransform2(deep_supervision_scales, 0, input_key='target',
                                                              output_key='target'))
        if use_wavelets:
            tr_transforms.append(WaveletDownsampleD(wavelet_scales, input_key='data', output_key='data', mode=0))
    ...
    def get_validation_transforms(deep_supervision_scales: Union[List, Tuple],
        ...
        if deep_supervision_scales is not None:
            val_transforms.append(DownsampleSegForDSTransform2(deep_supervision_scales, 0, input_key='target',
                                                               output_key='target'))
        if use_wavelets:
            val_transforms.append(WaveletDownsampleD(wavelet_scales, input_key='data', output_key='data', mode=0))
