...
class UpsampleTransform(nn.Module):
    def __init__(self, input_dim, output_dim):
        super(UpsampleTransform, self).__init__()
        self.linear = nn.Linear(input_dim, output_dim)
...
class DW_bn_relu_3d(nn.Module):
    def __init__(self, dim=768):
        super(DW_bn_relu_3d, self).__init__()
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(
        ...
        self.dwconv_1 = DW_bn_relu_3d(48)
        self.dwconv_2 = DW_bn_relu_3d(96)
        self.dwconv_3 = DW_bn_relu_3d(192)
        self.dwconv_4 = DW_bn_relu_3d(384)
