...
from kannet.kannet import KANLinear, KAN
...
class UKAN(nn.Module):
    def __init__(self, num_classes, embed_dims=[128, 160, 256], drop_rate=0.1, drop_path_rate=0.1, norm_layer=nn.LayerNorm, depths=[1, 1, 1]):
        ...
        self.encoder4 = D_ConvLayer3D(kan_input_dim, kan_input_dim*2)
        self.encoder5 = D_ConvLayer3D(kan_input_dim*2, kan_input_dim*2)
        ...
        self.decoder1 = D_ConvLayer3D(embed_dims[0]*2, embed_dims[0]*2)
        self.decoder2 = D_ConvLayer3D(embed_dims[0]*2, embed_dims[0])
