...
parser.add_argument('-i', '--inputfolder', type=str, default="dataset/seg_mask2021")
...
for k, inputfile in enumerate(mask_list):
    ...
    for i, bsize in enumerate(batches):
        ...
        print("all_images contain", all_images)
        print("all_images type", type(all_images))
        t1_images = all_images[:, 0, ...]
        print("all_images type t1", type(all_images[:, 0, ...]))
