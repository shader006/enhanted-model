...
class DefaultPreprocessor(object):
    ...
    def get_iterable_list(self):
        ...
        # print(f"fuscc_cases is {fuscc_cases}")
        # print(f"fuscc_cases_mask is {fuscc_cases_mask}")
        # exit(0)
        ...
        # print(f"fuscc_cases_nonbm is {fuscc_cases_nonbm}")
        # print(f"fuscc_cases_nonbm_mask is {fuscc_cases_nonbm_mask}")
        # exit(0)
